...
const getArtistProduct = {
    ...
    handler: async (req, res) => {
        try {
            ...
            console.error("Error getting artist products:", error);
    ...
    handler: [
        ...
        async (req, res) => {
            try {
                ...
                console.log("node 1");
                console.log(userID, name, aboutContent, biography);
                ...
                console.log("node 2");
                res.status(200).json({ artist: newArtist });
            } catch (error) {
...
const getBiography = {
    ...
    handler: async (req, res) => {
        try {
            ...
            let artist = await Artist.findOne({ _id: id });
            console.log("Artist findOne by _id:", artist);

            if (!artist) {
                artist = await Artist.findOne({ userID: id });
                console.log("Artist findOne by userID:", artist);
            ...
            console.log("Sending response:", artist);
            res.status(200).json({ artist });
        } catch (error) {
            console.error("Error getting biography:", error);
            res.status(500).json({ message: "Internal Server Error" });
        }
    },
};
    ...
    handler: [
        ...
        async (req, res) => {
            try {
                ...
                console.error("Error adding artist event:", error);
                res.status(500).json({ message: "Internal Server Error" });
            }
        },
    ],
